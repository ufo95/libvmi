...
size_t
vmi_write_ksym(vmi_instance_t vmi, char *sym, void *buf, size_t count)
{
...
static status_t
vmi_write_X_pa(vmi_instance_t vmi, addr_t paddr, void *value, int size)
{
...
status_t
vmi_write_8_pa(vmi_instance_t vmi, addr_t paddr, uint8_t * value)
{
    return vmi_write_X_pa(vmi, paddr, value, 1);
}

status_t
vmi_write_16_pa(vmi_instance_t vmi, addr_t paddr, uint16_t * value)
{
    return vmi_write_X_pa(vmi, paddr, value, 2);
}

status_t
vmi_write_32_pa(vmi_instance_t vmi, addr_t paddr, uint32_t * value)
{
    return vmi_write_X_pa(vmi, paddr, value, 4);
}

status_t
vmi_write_64_pa(vmi_instance_t vmi, addr_t paddr, uint64_t * value)
{
...
status_t
vmi_write_8_va(vmi_instance_t vmi, addr_t vaddr, int pid, uint8_t * value)
{
    return vmi_write_X_va(vmi, vaddr, pid, value, 1);
}

status_t
vmi_write_16_va(vmi_instance_t vmi, addr_t vaddr, int pid, uint16_t * value)
{
    return vmi_write_X_va(vmi, vaddr, pid, value, 2);
}

status_t
vmi_write_32_va(vmi_instance_t vmi, addr_t vaddr, int pid, uint32_t * value)
{
    return vmi_write_X_va(vmi, vaddr, pid, value, 4);
}

status_t
vmi_write_64_va(vmi_instance_t vmi, addr_t vaddr, int pid, uint64_t * value)
{
...
static status_t
vmi_write_X_ksym(vmi_instance_t vmi, char *sym, void *value, int size)
{
...
status_t
vmi_write_8_ksym(vmi_instance_t vmi, char *sym, uint8_t * value)
{
    return vmi_write_X_ksym(vmi, sym, value, 1);
}

status_t
vmi_write_16_ksym(vmi_instance_t vmi, char *sym, uint16_t * value)
{
    return vmi_write_X_ksym(vmi, sym, value, 2);
}

status_t
vmi_write_32_ksym(vmi_instance_t vmi, char *sym, uint32_t * value)
{
    return vmi_write_X_ksym(vmi, sym, value, 4);
}

status_t
vmi_write_64_ksym(vmi_instance_t vmi, char *sym, uint64_t * value)
{
