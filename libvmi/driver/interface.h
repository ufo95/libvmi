...
status_t driver_get_name_from_id(vmi_instance_t vmi,
...
status_t driver_get_vcpureg(vmi_instance_t vmi,
                            reg_t *value,
                            registers_t reg, unsigned long vcpu);
status_t driver_set_vcpureg(vmi_instance_t vmi,
...
status_t driver_write(vmi_instance_t vmi,
...
status_t driver_set_mem_access(vmi_instance_t vmi,
                               mem_event_t event,
                               vmi_mem_access_t page_access_flag);
status_t driver_set_reg_access(vmi_instance_t vmi, reg_event_t event);
status_t driver_start_single_step(vmi_instance_t vmi,
