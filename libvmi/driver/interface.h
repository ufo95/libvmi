...
status_t driver_get_name_from_id(vmi_instance_t vmi, unsigned long domid, char **name);
unsigned long driver_get_id(vmi_instance_t vmi);
void driver_set_id(vmi_instance_t vmi, unsigned long id);
status_t driver_check_id(vmi_instance_t vmi, unsigned long id);
...
status_t driver_set_vcpureg(vmi_instance_t vmi, reg_t value, registers_t reg, unsigned long vcpu);
...
status_t driver_events_listen(vmi_instance_t vmi, uint32_t timeout);
status_t driver_set_mem_access(vmi_instance_t vmi, mem_event_t event, vmi_mem_access_t page_access_flag);
status_t driver_set_reg_access(vmi_instance_t vmi, reg_event_t event);
status_t driver_start_single_step(vmi_instance_t vmi, single_step_event_t event);
status_t driver_stop_single_step(vmi_instance_t vmi, unsigned long vcpu);
status_t driver_shutdown_single_step(vmi_instance_t vmi);
status_t
