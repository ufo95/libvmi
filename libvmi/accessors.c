...
page_mode_t
vmi_get_page_mode(vmi_instance_t vmi)
{
...
uint8_t
vmi_get_address_width(vmi_instance_t vmi)
{
    uint8_t width = 0;
...
uint32_t
vmi_get_access_mode(vmi_instance_t vmi)
{
    return vmi->mode;
}

os_t
vmi_get_ostype(vmi_instance_t vmi)
{
    return vmi->os_type;
}

win_ver_t
vmi_get_winver(vmi_instance_t vmi)
{
...
const char *
vmi_get_winver_str(vmi_instance_t vmi)
{
...
win_ver_t
vmi_get_winver_manual(vmi_instance_t vmi, addr_t kdvb_pa)
{
    return find_windows_version(vmi, kdvb_pa);
}

unsigned long
vmi_get_offset(vmi_instance_t vmi, char *offset_name)
{
...
unsigned long
vmi_get_memsize(vmi_instance_t vmi)
{
    return vmi->size;
}

unsigned int
vmi_get_num_vcpus(vmi_instance_t vmi)
{
...
status_t
vmi_pause_vm(vmi_instance_t vmi)
{
    return driver_pause_vm(vmi);
}

status_t
vmi_resume_vm(vmi_instance_t vmi)
{
    return driver_resume_vm(vmi);
}

char *
vmi_get_name(vmi_instance_t vmi)
{
...
unsigned long
vmi_get_vmid(vmi_instance_t vmi)
{
