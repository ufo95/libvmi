...
/* bit flag testing */
int
entry_present(os_t os_type, uint64_t entry)
{
...
uint64_t
get_bits_51to12(uint64_t value)
{
...
/* PML4 Table  */
addr_t
get_pml4_index(addr_t vaddr)
{
    return (vaddr & 0x0000FF8000000000ULL) >> 36;
}

uint64_t
get_pml4e(vmi_instance_t vmi, addr_t vaddr, reg_t cr3)
{
    uint64_t value = 0;
...
uint32_t
get_pdptb(uint32_t pdpr)
{
    return pdpr & 0xFFFFFFE0;
}

uint32_t
pdpi_index(uint32_t pdpi)
{
    return (pdpi >> 30) * sizeof(uint64_t);
}

uint64_t
get_pdpi(vmi_instance_t instance, uint32_t vaddr, uint32_t cr3)
{
    uint64_t value;
...
addr_t
get_pdpt_index_ia32e(addr_t vaddr)
{
...
/* page directory */
uint32_t
pgd_index(vmi_instance_t instance, uint32_t address)
{
    if (!instance->pae) {
...
uint32_t
pdba_base_nopae(uint32_t pdpe)
{
    return pdpe & 0xFFFFF000;
}

uint64_t
pdba_base_pae(uint64_t pdpe)
{
    return pdpe & 0xFFFFFF000ULL;
}

uint32_t
get_pgd_nopae(vmi_instance_t instance, uint32_t vaddr, uint32_t pdpe)
{
    uint32_t value;
...
uint64_t
get_pgd_pae(vmi_instance_t instance, uint32_t vaddr, uint64_t pdpe)
{
    uint64_t value;
...
uint64_t
get_pd_index_ia32e(addr_t vaddr)
{
    return (vaddr & 0x000000003FE00000ULL) >> 18;
}

uint64_t
get_pde_ia32e(vmi_instance_t vmi, addr_t vaddr, uint64_t pdpte)
{
    uint64_t value = 0;
...
/* page table */
uint32_t
pte_index(vmi_instance_t instance, uint32_t address)
{
    if (!instance->pae) {
...
uint32_t
ptba_base_nopae(uint32_t pde)
{
    return pde & 0xFFFFF000;
}

uint64_t
ptba_base_pae(uint64_t pde)
{
    return pde & 0xFFFFFF000ULL;
}

uint32_t
get_pte_nopae(vmi_instance_t instance, uint32_t vaddr, uint32_t pgd)
{
    uint32_t value;
...
uint64_t
get_pte_pae(vmi_instance_t instance, uint32_t vaddr, uint64_t pgd)
{
    uint64_t value;
...
uint64_t
get_pt_index_ia32e(addr_t vaddr)
{
    return (vaddr & 0x00000000001FF000ULL) >> 9;
}

uint64_t
get_pte_ia32e(vmi_instance_t vmi, addr_t vaddr, uint64_t pde)
{
    uint64_t value = 0;
...
/* page */
uint32_t
pte_pfn_nopae(uint32_t pte)
{
    return pte & 0xFFFFF000;
}

uint64_t
pte_pfn_pae(uint64_t pte)
{
    return pte & 0xFFFFFF000ULL;
}

uint32_t
get_paddr_nopae(uint32_t vaddr, uint32_t pte)
{
    return pte_pfn_nopae(pte) | (vaddr & 0xFFF);
}

uint64_t
get_paddr_pae(uint32_t vaddr, uint64_t pte)
{
    return pte_pfn_pae(pte) | (vaddr & 0xFFF);
}

uint64_t
get_paddr_ia32e(addr_t vaddr, uint64_t pte)
{
    return get_bits_51to12(pte) | (vaddr & 0x0000000000000FFFULL);
}

uint32_t
get_large_paddr(vmi_instance_t instance, uint32_t vaddr, uint32_t pgd_entry)
{
    if (!instance->pae) {
...
uint64_t
get_gigpage_ia32e(addr_t vaddr, uint64_t pdpte)
{
    return (pdpte & 0x000FFFFFC0000000ULL) | (vaddr & 0x000000003FFFFFFFULL);
}

uint64_t
get_2megpage_ia32e(addr_t vaddr, uint64_t pde)
{
...
int
get_transition_bit(uint32_t entry)
{
    return vmi_get_bit(entry, 11);
}

int
get_prototype_bit(uint32_t entry)
{
    return vmi_get_bit(entry, 10);
}

void
buffalo_nopae(vmi_instance_t instance, uint32_t entry, int pde)
{
...
/* translation */
addr_t
v2p_nopae(vmi_instance_t vmi, addr_t dtb, addr_t vaddr)
{
    addr_t paddr = 0;
    uint32_t pgd, pte;
...
addr_t
v2p_pae(vmi_instance_t vmi, addr_t dtb, addr_t vaddr)
{
    addr_t paddr = 0;
...
addr_t
v2p_ia32e(vmi_instance_t vmi, addr_t dtb, addr_t vaddr)
{
    addr_t paddr = 0;
...
addr_t
vmi_pagetable_lookup(vmi_instance_t vmi, addr_t dtb, addr_t vaddr)
{
    addr_t paddr = 0;
...
addr_t
vmi_translate_kv2p(vmi_instance_t vmi, addr_t virt_address)
{
    reg_t cr3 = 0;
...
addr_t
vmi_translate_uv2p_nocache(vmi_instance_t vmi, addr_t virt_address, int pid)
{
...
addr_t
vmi_translate_uv2p(vmi_instance_t vmi, addr_t virt_address, int pid)
{
    addr_t dtb = vmi_pid_to_dtb(vmi, pid);
...
addr_t
vmi_translate_ksym2v(vmi_instance_t vmi, char *symbol)
{
    addr_t ret = 0;
...
addr_t
vmi_pid_to_dtb(vmi_instance_t vmi, int pid)
{
    addr_t dtb = 0;
...
int
vmi_dtb_to_pid(vmi_instance_t vmi, addr_t dtb)
{
